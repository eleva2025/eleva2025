...
XANO_API_KEY = os.getenv('XANO_API_KEY', "curl -X 'GET' \
'https://xidg-u2cu-sa8e.n7c.xano.io/api:loOqZbWF/user_eleva' \
-H 'Content-Type: application/json' \
-H 'Authorization: eyJhbGciOiJBMjU2S1ciLCJlbmMiOiJBMjU2Q0JDLUhTNTEyIiwiemlwIjoiREVGIn0.S0efcs6KgLQ4ht6g53tFfKQdhHaVG80WBEYImF_5HBbdHk6qD16fiHDg8vw5ex0LvT9GimFD1KU6dFrwBD8H_S3xcz3VKZcQ.Hp1jVLQddB0qFvQrP0tfcg.Ry9dfigOiVui9JXkk9hYpm5Bl17IqJYTmgDOAGggHX1CFTum5cMXKkurJN7SaydjYUOCLwqTgu0G1Kvglnp3enhItkGmuNEZ8UnLvCw95kAqzYSfZHcZfG5sIY4Po3UyMfRUFQD3SAnwphpUaSUz5g.hoajqCuM9MkpJpR_hOzAtSjBaKLdkWcU11z4zHaeVoM'")
        ...
        for d in raw_disciplines:
            ...
            if discipline_id == 6:
                ...
                try:
                    ...
                    respostas_11 = xano_request('GET', 'respostas_prova_11') or []
                    respostas_12 = xano_request('GET', 'respostas_prova_12') or []
                except Exception as e:
    ...
    if request.method == 'POST':
        ...
        if ja_respondido:
            ...
            try:
                ...
                xano_request('POST', 'respostas_prova_7', data=payload)
                flash("Prova enviada com sucesso!", "success")
                return redirect(url_for('student_dashboard'))
    ...
    if request.method == 'POST':
        ...
        if ja_respondido:
            ...
            try:
                ...
                xano_request('POST', 'respostas_prova_8', data=payload)
                flash("Prova enviada com sucesso!", "success")
                return redirect(url_for('student_dashboard'))
...
def prova9(disciplina_id):
    ...
    # ✅ Verificar se o aluno já respondeu usando apenas o aluno_nome
    try:
        resposta_existente = xano_request('GET', 'respostas_prova_9', params={
            'aluno_nome': aluno_nome
        })
        # após o GET
        resposta_existente = xano_request('GET', 'respostas_prova_9', params={
    ...
    if request.method == 'POST':
        ...
        if ja_respondido:
            ...
            try:
                ...
                xano_request('POST', 'respostas_prova_9', data=payload)
                flash("Prova enviada com sucesso!", "success")
                return redirect(url_for('student_dashboard'))
...
def prova11(disciplina_id):
    ...
    # ✅ Verificar se o aluno já respondeu usando apenas o aluno_nome
    try:
        resposta_existente = xano_request('GET', 'respostas_prova_11', params={
            'aluno_nome': aluno_nome
        })
        # após o GET
        resposta_existente = xano_request('GET', 'respostas_prova_11', params={
    ...
    if request.method == 'POST':
        ...
        if ja_respondido:
            ...
            try:
                ...
                xano_request('POST', 'respostas_prova_11', data=payload)
                flash("Prova enviada com sucesso!", "success")
                return redirect(url_for('student_dashboard'))
...
def prova12(disciplina_id):
    ...
    # ✅ Verificar se o aluno já respondeu usando apenas o aluno_nome
    try:
        resposta_existente = xano_request('GET', 'respostas_prova_12', params={
            'aluno_nome': aluno_nome
        })
        # após o GET
        resposta_existente = xano_request('GET', 'respostas_prova_12', params={
    ...
    if request.method == 'POST':
        ...
        if ja_respondido:
            ...
            try:
                ...
                xano_request('POST', 'respostas_prova_12', data=payload)
                flash("Prova enviada com sucesso!", "success")
                return redirect(url_for('student_dashboard'))
